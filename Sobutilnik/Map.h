...
namespace Sobutilnik {
	...
	private:
		...
		bool isExitButton, ReadyOrNotReady;
	...
	private: System::Windows::Forms::Panel^  ReadyOrNot;
		String^ profileImage;
		void pnaelPaint();
...
#pragma region Windows Form Designer generated code
			 void InitializeComponent(void)
			 {
				 ...
				 this->ReadyOrNot = (gcnew System::Windows::Forms::Panel());
				 ...
				 // Drunk
				 // 
				 this->Drunk->Location = System::Drawing::Point(2, 2);
				 this->Drunk->Name = L"Drunk";
				 this->Drunk->Size = System::Drawing::Size(136, 44);
				 this->Drunk->TabIndex = 5;
				 this->Drunk->Text = L"Хочу бухать!";
				 this->Drunk->UseVisualStyleBackColor = true;
				 this->Drunk->Click += gcnew System::EventHandler(this, &Map::Drunk_Click);
				 // 
				 // label1
				 // 
				 ...
				 this->FriendsPanel->Location = System::Drawing::Point(992, 586);
				 ...
				 this->MessagesPanel->Location = System::Drawing::Point(1209, 72);
				 this->MessagesPanel->Name = L"MessagesPanel";
				 this->MessagesPanel->Size = System::Drawing::Size(787, 418);
				 this->MessagesPanel->TabIndex = 12;
				 this->MessagesPanel->Visible = false;
				 // 
				 // sendMsgButton
				 // 
				 this->sendMsgButton->Location = System::Drawing::Point(698, 366);
				 this->sendMsgButton->Margin = System::Windows::Forms::Padding(2);
				 this->sendMsgButton->Name = L"sendMsgButton";
				 this->sendMsgButton->Size = System::Drawing::Size(69, 25);
				 ...
				 // msgTextBox
				 // 
				 this->msgTextBox->Location = System::Drawing::Point(0, 352);
				 this->msgTextBox->Margin = System::Windows::Forms::Padding(2);
				 this->msgTextBox->Multiline = true;
				 this->msgTextBox->Name = L"msgTextBox";
				 this->msgTextBox->Size = System::Drawing::Size(670, 53);
				 this->msgTextBox->TabIndex = 16;
				 // 
				 // massegeListBox
				 // 
				 this->massegeListBox->FormattingEnabled = true;
				 this->massegeListBox->Location = System::Drawing::Point(0, 58);
				 this->massegeListBox->Margin = System::Windows::Forms::Padding(2);
				 this->massegeListBox->Name = L"massegeListBox";
				 this->massegeListBox->Size = System::Drawing::Size(788, 277);
				 ...
				 this->profilePanel->Controls->Add(this->ReadyOrNot);
				 ...
				 this->profilePanel->Location = System::Drawing::Point(88, 554);
				 ...
				 // ReadyOrNot
				 // 
				 this->ReadyOrNot->BackColor = System::Drawing::Color::IndianRed;
				 this->ReadyOrNot->Controls->Add(this->Drunk);
				 this->ReadyOrNot->Location = System::Drawing::Point(24, 209);
				 this->ReadyOrNot->Name = L"ReadyOrNot";
				 this->ReadyOrNot->Size = System::Drawing::Size(140, 48);
				 this->ReadyOrNot->TabIndex = 66;
				 // 
				 // webPageButton
				 // 
				 ...
				 this->webPageButton->TabIndex = 10;
				 ...
				 this->instagramButton->TabIndex = 7;
				 ...
				 this->SettingsPanel->Location = System::Drawing::Point(290, 23);
				 ...
				 this->webPageLinkField->TabIndex = 38;
				 // 
				 // vkLinkField
				 // 
				 ...
				 this->twitterLinkField->TabIndex = 36;
				 // 
				 // instagramkLinkField
				 // 
				 ...
				 this->instagramkLinkField->TabIndex = 35;
				 // 
				 // facebookLinkField
				 // 
				 ...
				 this->userDrinksChangeField->TabIndex = 33;
				 // 
				 ...
				 this->userHobbyChangeField->TabIndex = 32;
				 // 
				 ...
				 this->userDescriptionChangeField->TabIndex = 31;
				 // 
				 // label18
				 // 
				 ...
				 this->newSurnameField->TabIndex = 28;
				 // 
				 // GeoPosition
				 // 
				 ...
				 this->newPasswordField->TabIndex = 27;
				 // 
				 ...
				 this->currentPasswordField->TabIndex = 26;
				 // 
				 // ChangeProfileImage
				 // 
				 ...
				 this->ChangeProfileImage->TabIndex = 25;
				 ...
				 // ExitAccount
				 // 
				 this->ExitAccount->BackColor = System::Drawing::Color::Transparent;
				 ...
				 this->ReadyOrNot->ResumeLayout(false);
...
private: System::Void Drunk_Click(System::Object^  sender, System::EventArgs^  e);
};
}