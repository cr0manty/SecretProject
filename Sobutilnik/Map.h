...
namespace Sobutilnik {
	...
	public:
		...
		Map(FirstPage ^f, int _id) : mainPage(f), userId(_id), isExitButton(0)
		{
			...
			profileImage = nullptr;
			initLabels();
			searchResult = new std::map<int, int>;
		}
	protected:
		/// <summary>
...
#pragma region Windows Form Designer generated code
			 void InitializeComponent(void)
			 {
				 ...
				 this->label11->Location = System::Drawing::Point(25, 30);
				 ...
				 this->resultListBox->Location = System::Drawing::Point(28, 113);
				 ...
				 // searchButton
				 // 
				 this->searchButton->Location = System::Drawing::Point(215, 76);
				 ...
				 // searchField
				 // 
				 this->searchField->Location = System::Drawing::Point(28, 76);
				 ...
				 this->profilePanel->Location = System::Drawing::Point(357, 517);
